...
| ------------------------------------------- | --------------------------------------------| ------------- | -----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Data Scientist                              | Unifier AI                                   | Mar 2024 - Present | Prepare high-quality textual data for training question-answering LLM on data topics & execute the training pipeline.     
                                       |
...
| Data Management & Analytics (Co-op)         | PathtoCareer Inc.                            | May 2024 - Aug 2024 | Enhance platform data and user engagement through targeted data analysis and data governance principles.                 
                                       |
