...
| News Reader             | News aggregation and reading application - Fetches top news headlines via real-time API requests       | Python, App Designing, API requests, GUI| [https://github.com/rashika-dabas/NewsReader](https://github.com/rashika-dabas/NewsReader)             |
