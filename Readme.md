...
|--------------------------------------------------------------|--------------------------------------------------------|---------------------|-----------------------------------------------------------------------------------------------------------------------------|
| Financial Data Analyst (Operations)                                               | Wellington-Altus Private Wealth Inc.                                             | Dec 2024 - Oct 2025  | Execute timely and efficient data validations for internal platforms & advisor teams via request handling & financial analysis.           |
| Business Intelligence Analyst & Student Chapters Coordinator | BACG (Business Analytics Consulting Group Canada Ltd.) | Aug 2024 - Oct 2024  | Grow industry collaboration hub via decision-making and initiate industry & student chapters for subscription-based models. |
...
| Data Scientist                                               | [LetsGrowMore](https://medium.com/@rashika.educator19/my-first-experience-as-a-data-science-intern-3371d5bc1dde)                                           | Sep 2021 - Oct 2021 | Train machine learning algorithms from scratch and improve performance by tuning model thresholds using scikit-learn.       |
...
| Content Platform Head                                        | Metvy Net Pvt. Ltd.                                    | Jun 2021 - Oct 2021 | Oversee content strategy and execution for branding team's social media handles (LinkedIn and Quora).                       |
...
|-----------------------|-----------------------------------------------|-------------------------------|------------------------------------------------------------|
| Heart Failure Predictor   | Predicts the occurrence of a heart failure using Machine Learning models.  | Python, ML, Data Analysis & Cleaning, Data Modelling, Healthcare  | [https://github.com/rashika-dabas/Heart-Failure-Predictor](https://github.com/rashika-dabas/Heart-Failure-Predictor) |
| Medium Article Scraper    | Scrapes all the important information from a Medium article webpage using BeautifulSoup Library.                 | Python, Web Scraping, Information Retrieval, Regular Expressions (Regex), File Handling            | [https://github.com/rashika-dabas/Medium-Article-Scraper](https://github.com/rashika-dabas/Medium-Article-Scraper)   |
| AI Detector             | Classifies essays into LLM-generated or human-generated texts via Neural Networks implementation and Agile adoption.                    | Python, DL, Agile Methodologies, Neural Networks, UI Development, NLP, Data Analysis   | [https://github.com/rashika-dabas/AI-Detector](https://github.com/rashika-dabas/AI-Detector)                 |
| CinePulse               | An emotion-based movie ranker using facial recognition and emotion detection.                  | Python, Market Research, Data Modelling, Facial Recognition, Recommendation Systems, Deployment, GCP      | [https://github.com/rashika-dabas/CinePulse](https://github.com/rashika-dabas/CinePulse)                   |
| VR Audio Description    | Describes audio for activity in VR environments by finetuning the GPT model using a customized synthetic dataset.        | Python, LLMs, Accessibility, Finetuning, Data Generation, Autoencoders    | [https://github.com/rashika-dabas/VR-Audio-Description](https://github.com/rashika-dabas/VR-Audio-Description)   |
| AI Ethics               | Explores ethical considerations in AI fostering responsible AI principles.        | AI Ethics, Explainable AI, AI Regulations & Laws, AI Frameworks             | [https://github.com/rashika-dabas/AI-Ethics](https://github.com/rashika-dabas/AI-Ethics)                   |
| Amazon Crawling         | Scrapes Amazon products' data via Scrapy agents from multiple pages.          | Python, Web Scraping, NoSQL, HTML, GitHub            | [https://github.com/rashika-dabas/Amazon-Crawling](https://github.com/rashika-dabas/Amazon-Crawling)         |
| Web Authenticator       | A web authentication system which can be integrated into secure websites.                    | Python, Security, Web Development, User AUthentication, App Development, Salesforce      | [https://github.com/rashika-dabas/Web-Authenticator](https://github.com/rashika-dabas/Web-Authenticator)       |
| Student Placement App   | A student-friendly Android app to predict his/her chances of securing a placement/job.   | Python, App Development, Statistical Modelling, API testing, Machine Learning, Deployment, Salesforce     | [https://github.com/rashika-dabas/Student-Placement-App](https://github.com/rashika-dabas/Student-Placement-App)   |
| ChatbotRashi            | Chatbot deployed on Telegram for small talk and currency conversion.                  | Python, NLP, Chatbots, Google DialogFlow, Deployment           | [https://github.com/rashika-dabas/ChatbotRashi](https://github.com/rashika-dabas/ChatbotRashi)            |
| Login GUI               | Graphical user interface for successful application login.           | Python, GUI Development, Web Authentication, App Designing        | [https://github.com/rashika-dabas/LoginGUI](https://github.com/rashika-dabas/LoginGUI)               |
| News Reader             | News aggregation and reading application - Fetches top news headlines via real-time API requests.       | Python, App Designing, API requests, GUI Development| [https://github.com/rashika-dabas/NewsReader](https://github.com/rashika-dabas/NewsReader)             |
| Movie Recommendation System| Recommends movies based on user preferences by fetching movie data through API requests from the famous TMDB.  | Python, ML, Recommendation Systems, Deployment, Releases & Pipelines, Salesforce | [https://github.com/rashika-dabas/Movie-Recommendation-System](https://github.com/rashika-dabas/Movie-Recommendation-System) |
...
| Employment Analytics              | Delves into driving awareness and providing detailed stakeholder reports for educational pathways.          | Python, Excel, Power BI, AI, Dashboarding, Storytelling             | Private/Confidential Repository              |
...
Movie Recommendation System aims to strategize the recommendation process for movies on entertainment platforms by acquiring similar films. The system is designed to fetch movie data (titles and associated images) through API requests from The Movie Database (TMDB). The approach involved processing approximately 5,000 movie tags using data pre-processing, feature engineering and exploratory data analysis techniques. The model workflow was revamped using the Ast library for handling strings and creating lambda & apply functions. A PKL model file was tailored for similarity values using tokenization, feature extraction and cosine similarity. API testing was performed using Postman on the TMDB API to ensure end-to-end deployment. The project successfully culminated with model deployment on the Heroku by Salesforce platform, utilizing the Streamlit framework. <br /> <b> Subject Areas: </b> Data Science, Machine Learning, Natural Language Processing (NLP), Data Preprocessing and Analysis, API Integration, Deployment (Salesforce)

### 14. WhatsApper:
WhatsApper showcases a project that analyzes WhatsApp chat data through statistics and visualizations using a Streamlit app. The project aims to provide insights into WhatsApp conversations by processing and presenting chat data in a user-friendly manner. Users can download their WhatsApp chat history and use it as input for the analysis. One notable feature of WhatsApper is its ability to handle Hinglish (a mixture of Hindi and English) text by incorporating Hinglish stop words in the preprocessing stage. This makes the tool particularly useful for analyzing conversations that contain mixed language content. This user-friendly Streamlit app is accessible to both developers and non-technical users interested in analyzing their WhatsApp conversations. <br /> <b> Subject Areas: </b> Data Analysis, Natural Language Processing (NLP), Web Application Development, Data Visualization, Python Programming, Streamlit, Hinglish Text Processing

### 15. Clicked Data Analysis Sprint:
Clicked Data Analysis Sprint focuses on basketball statistics utilizing a dataset from Kaggle containing NBA data and employs tools such as Python, SQL, Perplexity.AI and Deepnote for analysis. Gamma tool is used to design the final presentation with all the ingights and recommendations. The project is structured into four main phases: accessing & understanding the data, performing SQL analysis, generating insights and developing recommendations. Each phase had a specific timeline, with the entire project spanning from July 29 to August 16, 2024. The project plan outlines steps for connecting to the database, examining data structure, writing SQL queries and identifying trends and patterns in the data. The ultimate goal was to generate actionable insights and recommendations for improving player, team or game performance for NBA. <br /> <b> Subject Areas: </b> Database Management, SQL Querying, Data Analysis and Interpretation, Sports Analytics, Data Visualization, Project Planning, Python Programming, Reporting, Application of AI tools

### 16. Employment Analytics:
Employment Analytics project analyzes career pathways and employment data to provide valuable insights into various career options, requirements and prospects. The project involves gathering data from proprietary websites and job banks using AI-based platforms like ChatGPT, Gemini and Perplexity.AI. Primary tasks include researching and analyzing data needs, ensuring data quality through rigorous checks and performing data cleansing & enrichment. The project emphasizes the importance of ethical data collection and storage as well as engaging with educational institutions to drive awareness. The research criteria for each career include a comprehensive set of output details, such as career descriptions, salary ranges in Canada, language requirements, job duties, future scope and educational requirements. The project also focuses on maintaining data quality by ensuring accuracy, completeness, reliability, relevance and timeliness. <br /> <b> Subject Areas: </b> Data Gathering and Analysis, AI-assisted Data Collection, Data Quality Assurance, Market Research and Projections, Requirements Analysis, Data Visualization and Reporting, Ethical Data Handling, Stakeholder Engagement and Communication
